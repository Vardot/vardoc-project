[![Build Status](https://travis-ci.org/Vardot/vardoc.svg?branch=8.x-1.0-rc7)](https://travis-ci.org/Vardot/vardoc/builds/411242342) Vardoc 8.1.0-rc7
# Vardoc Project
...
```
composer create-project Vardot/vardoc-project:^8.1.0-rc7 PROJECT_DIR_NAME --no-dev --no-interaction
```
