[![Build Status](https://api.travis-ci.org/Vardot/vardoc.svg?branch=5.0.0-alpha2)](https://travis-ci.com/github/Vardot/vardoc/builds/226645942) Vardoc 5.0.0-alpha2
# Vardoc Project
